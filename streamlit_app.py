...
# Page de Prédiction
    ...
    with st.expander("Correspondance des intervalles") :
        ...
        'salaire_employe_discretise': ['(8.691,10.46]','(10.46, 12.22]','(12.22, 13.98]','(13.98, 15.74]','(15.74, 17.5]'],
        'salaire_homme_discretise': ['(10.358, 18.8]','(18.8, 27.2]','(27.2, 35.6]','(35.6, 44.0]','(44.0, 52.4]'],
